...
import { Building2, Mail, Lock, User, Eye, EyeOff, Key } from 'lucide-react';
...
const Auth: React.FC = () => {
  ...
  const handlePasswordReset = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await apiService.resetPassword(resetForm);
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-white py-8 px-6 shadow-xl rounded-lg">
            <form onSubmit={handlePasswordReset} className="space-y-6">
              <div>
                <label htmlFor="reset-org-name" className="block text-sm font-medium text-gray-700">
                  Organization Name
                </label>
                <div className="mt-1 relative">
                  ...
                  <input
                    ...
                    type="text"
                    required
                    value={resetForm.organizationName}
                    onChange={(e) => setResetForm({ ...resetForm, organizationName: e.target.value })}
              ...
              <div>
                <label htmlFor="reset-old-password" className="block text-sm font-medium text-gray-700">
                  Current Password
                </label>
                <div className="mt-1 relative">
